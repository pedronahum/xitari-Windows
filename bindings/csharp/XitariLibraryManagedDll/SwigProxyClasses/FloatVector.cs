...
public class FloatVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IList<float>
 {
  ...
  public FloatVector(FloatVector other) : this(XitariLibPINVOKE.new_FloatVector__SWIG_1(FloatVector.getCPtr(other)), true) {
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public FloatVector(int capacity) : this(XitariLibPINVOKE.new_FloatVector__SWIG_2(capacity), true) {
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  private float getitemcopy(int index) {
    float ret = XitariLibPINVOKE.FloatVector_getitemcopy(swigCPtr, index);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private float getitem(int index) {
    float ret = XitariLibPINVOKE.FloatVector_getitem(swigCPtr, index);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, float val) {
    XitariLibPINVOKE.FloatVector_setitem(swigCPtr, index, val);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(FloatVector values) {
    XitariLibPINVOKE.FloatVector_AddRange(swigCPtr, FloatVector.getCPtr(values));
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public FloatVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = XitariLibPINVOKE.FloatVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, float x) {
    XitariLibPINVOKE.FloatVector_Insert(swigCPtr, index, x);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, FloatVector values) {
    XitariLibPINVOKE.FloatVector_InsertRange(swigCPtr, index, FloatVector.getCPtr(values));
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    XitariLibPINVOKE.FloatVector_RemoveAt(swigCPtr, index);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    XitariLibPINVOKE.FloatVector_RemoveRange(swigCPtr, index, count);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public static FloatVector Repeat(float value, int count) {
    global::System.IntPtr cPtr = XitariLibPINVOKE.FloatVector_Repeat(value, count);
    FloatVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new FloatVector(cPtr, true);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse(int index, int count) {
    XitariLibPINVOKE.FloatVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, FloatVector values) {
    XitariLibPINVOKE.FloatVector_SetRange(swigCPtr, index, FloatVector.getCPtr(values));
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
  }
