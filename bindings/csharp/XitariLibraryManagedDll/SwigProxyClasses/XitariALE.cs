...
public class XitariALE : global::System.IDisposable {
  ...
  public FloatVector ale_getRescaledYChannelScreenHistory() {
    FloatVector ret = new FloatVector(XitariLibPINVOKE.XitariALE_ale_getRescaledYChannelScreenHistory(swigCPtr), true);
    return ret;
  }
  ...
  public UCharVector ale_resizeBilinearGray(UCharVector pixels, int w, int h, int w2, int h2) {
    UCharVector ret = new UCharVector(XitariLibPINVOKE.XitariALE_ale_resizeBilinearGray(swigCPtr, UCharVector.getCPtr(pixels), w, h, w2, h2), true);
    if (XitariLibPINVOKE.SWIGPendingException.Pending) throw XitariLibPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
